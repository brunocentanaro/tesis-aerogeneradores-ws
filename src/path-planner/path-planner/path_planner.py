...
def path_planner(windTurbine: WindTurbine=WindTurbine(80, 3, 40, "stl_gen/turbine"), start_position=[0, -30, 30]):
    create_stl(windTurbine)
    traj = shortest_path_from_stl(start_position, windTurbine.stl_path)
